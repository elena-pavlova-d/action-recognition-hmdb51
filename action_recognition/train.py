...
def train(cfg: DictConfig):
    # Конфигурация
    data_dir = Path("data")  # Изменили путь с data/data на просто data

    # Инициализация модуля данных
    datamodule = HumanActionDataModule(
        data_dir=data_dir,  # Теперь указываем корневую папку data
        batch_size=cfg.training.batch_size,
        num_workers=cfg.training.num_workers,
        seq_len=cfg.training.seq_len,
        num_classes=cfg.model.num_classes,  # Добавили передачу num_classes
